...
const Footer = () => {
    return (
        <div>
            <footer className="section-container justify-between footer xl:px-24 py-10 px-4 text-base-content">
                <aside>
            ...
            <hr />
            <footer className="items-center footer xl:px-24 py-10 px-4">
